  ...
  return (
    <>
      ...
      <nav className='flex items-center justify-between pt-8 px-20 fixed z-[100000] w-screen overflow-hidden'>
        ...
        <Image alt='' src='/vfsLogo.png' className='w-[15vw]'/>
      ...
      <div className='w-screen h-screen pt-16 overflow-hidden bg-[#ffe8df] fixed'>
        <Image alt='' src="/mandir.png" className='w-[72%] brightness-125 -right-[15vw] scaling-image z-[100] absolute'/>
        <div className='w-[50vw] overflow-hidden'>
          <Image alt='' src="/mantra.png"  className='w-[35%] z-[85] mx-auto rotating-image absolute right-[4.9vw]'/>
        </div>
        <Image alt='' src="/gradBg.png" className='absolute w-[90%] top-0 right-0'/>
